...
| Storage as a Service (Object Storage)                  | Sovereign Cloud                  | CSZ    | Object lock available                                                                                                           | Managed via StorageGRID Tenant Manager                      |
|                                                        | Sovereign Cloud                  | SSZ    | Object lock available                                                                                                           | Managed via StorageGRID Tenant Manager                      |
